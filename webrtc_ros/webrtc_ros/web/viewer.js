function on_ready (callback) {
  if (document.readyState !== 'loading') callback.call(document)
  else document.addEventListener('DOMContentLoaded', callback.bind(document))
}
...
on_ready(function () {
  ...
  if (Q.subscribe_video) {
    ...
    console.log(
      'No subscribe_video parameter, not connecting to WebRTC video stream'
    )
  }
})
